...
- **Code-first investigation**: Start task research from target source code, symbols, and direct callers before reading specification docs.
...
- **Current Implementation State**: Source Code > [`docs/status/`](docs/status/) > [`docs/design/`](docs/design/) > [`docs/specs/`](docs/specs/)
- **Normative Specification**: [`docs/specs/`](docs/specs/) > [`docs/design/`](docs/design/) > [`docs/status/`](docs/status/)
