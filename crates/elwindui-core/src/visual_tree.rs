...
//! `#[id(...)]` (docs/specs/dsl_spec.md §12), resolved entirely at compile time via a generated
...
/// based counterpart to its child/parent walk (docs/specs/dsl_spec.md §12's original `find_all`
