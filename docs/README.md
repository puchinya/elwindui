...
| [`status/appkit_ui_construction_memory_analysis.md`](status/appkit_ui_construction_memory_analysis.md) | AppKit graphics-demo のA/E/F/G/H/I/J段階測定、tab/UI tree/renderer分解、allocation attribution |
