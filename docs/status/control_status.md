...
| CustomTabView / CustomTabViewItem / CustomSplitter | 🚧 | 🚧 | ⬜ | #173 component-layer prerequisite: Core ownership, selection, pointer gesture, cancellation, splitter delta, and IconSourceElement realization are implemented; final external-consumer and host-path review evidence is being completed |
