...
Focused custom-control, external declarative-content, formatter, workspace build/check, and warning-regression verification passes on this branch. Native AppKit interaction for the GridSplitter change was not run; Windows and GTK4 runtime interaction remain unverified.
