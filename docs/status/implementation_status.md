...
| Context menu and PopupSurface | ✅ | platform-neutral `ContextRequest`, native NSMenu/MenuFlyout context menu, custom `ContextMenuPresenter`, and generic `PopupSurface` with AutoFlip placement and light dismiss are implemented and tested ([#152](https://github.com/puchinya/elwindui/issues/152)) |
